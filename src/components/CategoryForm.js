                    ...
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                        <>
                            <Form>
                                ...
                                <Item rounded style={styles.inputLogin} error={Boolean(errors.dataLevel && touched.dataLevel)}>
                                    <Picker
                                        mode="dropdown"
                                        ...
                                        selectedValue={values.dataLevel}
                                        onValueChange={handleChange('dataLevel')}
                                    >
                                        {totalCategory ? totalCategory.map((i, index) => (
                                            <Picker.Item label={`Level : ${index}`} value={`${index}`} />
