...
export default function PrinterForm({
  ...
  useEffect(() => {
    async function getPermissionBluetooth() {
      ...
      if (status !== 'granted') {
        alert(
          'Hey! You might want to enable bluetooth for my app, they are good.'
        );
      }
    }
          ...
          {({
            ...
            <>
              <Form>
                ...
                >
                  <FontAwesome5 name="toilet-paper" style={styles.iconInput} />
                  <Picker
                    mode="dropdown"
                  ...
                  >
                    <Picker.Item label="80mm" value="46" />
                    <Picker.Item label="58mm" value="30" />
                  </Picker>
                </Item>
              </Form>
              <Button
                ...
                disabled={Boolean(
                  errors.ipAddress || errors.port || errors.name
                )}
              >
                  ...
                  if (values.ipAddress && values.port) {
                    try {
                      ...
                      await NetPrinter.printBill(
                        `${COMMANDS.TEXT_FORMAT.TXT_ALIGN_CT}${COMMANDS.TEXT_FORMAT.TXT_BOLD_ON}Print ${values.name} Test${COMMANDS.TEXT_FORMAT.TXT_BOLD_OFF}`,
                        {
                          cut: true,
                        }
                      );
