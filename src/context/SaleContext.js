...
const fetchMenuSale = (dispatch) => (favorite, productname, category) => {
  ...
  backendApi
    .get(`/menu/sales/${favorite}/${productname}/${category}`)
    .then((response) => {
...
const addDiscount = (dispatch) => (id, value) => {
  return backendApi
    .put(`/sale/order-detail-discount/${id}`, value);
};
...
const fetchCustomer = (dispatch) => (query = "") => {
...
const getSaleTable = (dispatch) => (query = "") => {
